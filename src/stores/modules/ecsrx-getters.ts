...
export class EcsRxGetters
{
    public componentTypes = (state: any, getters: any, rootState: any, rootGetters: any): Array<TypeData> =>
    {
        ...
        return rootGetters["dotnet/allProjectTypes"].filter((x: TypeData) => x.metadata["nodeType"] == ComponentNode.NodeType.id);
    };
    ...
    public modelTypes = (state: any, getters: any, rootState: any, rootGetters: any): Array<TypeData> =>
    {
        ...
        return rootGetters["dotnet/allProjectTypes"].filter((x: TypeData) => x.metadata["nodeType"] == ModelNode.NodeType.id);
    };
    ...
    public eventTypes = (state: any, getters: any, rootState: any, rootGetters: any): Array<TypeData> =>
    {
        ...
        return rootGetters["dotnet/allProjectTypes"].filter((x: TypeData) => x.metadata["nodeType"] == EventNode.NodeType.id);
    };
    ...
    public groupTypes = (state: any, getters: any, rootState: any, rootGetters: any): Array<TypeData> =>
    {
        ...
        return rootGetters["dotnet/allProjectTypes"].filter((x: TypeData) => x.metadata["nodeType"] == GroupNode.NodeType.id);
    };
}